...
(let* ((base04  "#fdf6e3")
  ...
  (custom-theme-set-faces
   ...
   `(default                          ((t (:background ,base04  :foreground ,base03))))
   ...
   `(font-lock-comment-face           ((t (:slant italic :foreground ,base00))))
   ...
   `(mode-line-minor-mode-face        ((t (:foreground ,violet))))
   `(mode-line-buffer-id              ((t (:foreground ,base1))))
   `(mode-line-delim-face-1           ((t (:foreground ,base00))))
   ;; compilation
   `(compilation-info                 ((t (:forground ,green :bold t))))
   `(compilation-warning              ((t (:foreground ,orange :bold t))))
   ;; customize
   `(custom-button                    ((t (:background ,base2 :box (:line-width 2 :style released-button)))))
   ...
   ;; extra modules
   `(elscreen-tab-background-face     ((t (:background ,base3))))
   `(elscreen-tab-current-screen-face ((t (:background ,base3 :foreground ,base1 :bold t :italic t))))
   `(elscreen-tab-control-face        ((t (:background ,base2 :foreground ,base1))))
   `(elscreen-tab-other-screen-face   ((t (:background ,base2 :foreground ,base1 :underline nil))))
   ;; -------------
   ;; gnus
