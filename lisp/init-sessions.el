...
(setq desktop-base-file-name (concat ".emacs.desktop." (system-name))
      desktop-base-lock-name (concat ".emacs.desktop.lock." (system-name))
      desktop-path (list (concat user-emacs-directory "tmp/cache/"))
...
(setq savehist-file (concat user-emacs-directory "tmp/cache/savehist." (system-name)))
(savehist-mode t)

;; (require 'session)
;; (setq session-save-file (expand-file-name
;;                          (concat user-emacs-directory "tmp/cache/.session." (system-name))))
